...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        <!--begin::Content-->
        <div
            class="login-container order-1 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            <!--begin::Wrapper-->
                ...
                <div class="login-form">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5 text-center">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">اهلا بك في لوحة تحكم
                                تمور المعلم</h3>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                <label
                                    class="font-size-h6 font-weight-bolder text-dark pt-5">@lang('lang.email')</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                <label
                                    class="font-size-h6 font-weight-bolder text-dark pt-5">@lang('lang.password')</label>
                            </div>
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="submit" id="kt_login_singin_form_submit_button"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">@lang('lang.login')</button>
        ...
        <div class="login-aside order-2 order-lg-2 bgi-no-repeat bgi-position-x-left " >
            <div class="login-conteiner bgi-no-repeat bgi-position-x-center bgi-position-y-center"
                 style= "background-image: url({{asset('/')}}assets/media/login.png) ; background-color: #C5A477">
            </div>
