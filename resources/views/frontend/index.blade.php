                ...
                <div class="mb-4">
                    ...
                    <div class="input-group flex-nowrap">
                        <textarea type="number" required name="income_source" class="form-control"
                                  ...
                                  aria-describedby="addon-currency" id="income_source"></textarea>
                    </div>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group flex-nowrap">
                        <textarea type="number" required name="financial" class="form-control"
                                  ...
                                  aria-describedby="addon-currency" id="financial"></textarea>
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="input-group flex-nowrap">
                        <textarea type="number" required name="projects_owned" class="form-control"
                                  ...
                                  aria-describedby="addon-currency" id="projects_owned"></textarea>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        var checkbox = document.getElementById('is_cr_num');
        checkbox.addEventListener('change', function() {
            if (checkbox.checked) {
                document.getElementById('c_r_num').setAttribute('disabled', 'true');
                $('#c_r_num').val('');
