                ...
                <div class="form-body py-5">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link active" id="personal-info-tab" type="button">المعلومات الشخصية
                                </button>
                            </li>
                            <!-- <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="works-tab-pane" role="tabpanel" aria-labelledby="works-tab"
                                 tabindex="0">
                                <div class="mb-4">
                                    <p>هل أنت موظف</p>
                                    <div class="question ">
                            ...
                            <div class="tab-pane fade" id="financial-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-4">
                                    ...
                                    <button type="button" class="btn add-btn add-bank-btn"><i
                                            class="fa-solid fa-plus"></i></button>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="city_id" required class="form-select" aria-label="Small select example"
                                            id="city_id">
                            ...
                            <div class="tab-pane fade" id="delegation-tab-pane" role="tabpanel"
